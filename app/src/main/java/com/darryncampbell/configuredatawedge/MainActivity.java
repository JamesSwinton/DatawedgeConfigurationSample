...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btnConfigureDW)
        {
            ...
            DataWedgeUtilities.SetProfileConfig(this, profileNameActivity1,
                    "com.darryncampbell.capturedata", ".MainActivity");
            ...
            DataWedgeUtilities.SetProfileConfig(this, profileNameActivity2,
                    "com.darryncampbell.capturedata", ".SecondActivity");
